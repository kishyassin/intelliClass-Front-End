...
class ProfessorDashboardWidget extends StatefulWidget {
  const ProfessorDashboardWidget({super.key});
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 4.0, 0.0, 4.0),
                                    child: FutureBuilder<List<ClassesRow>>(
                                      future: ClassesTable().queryRows(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemCount:
                                              listViewClassesRowList.length,
                                          itemBuilder:
                                              (context, listViewIndex) {
                                            final listViewClassesRow =
                                                listViewClassesRowList[
                                                    listViewIndex];
                                            return Padding(
                                              padding: EdgeInsetsDirectional
